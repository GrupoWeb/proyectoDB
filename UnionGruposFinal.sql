...
--SECUENCIA Tipo Odontologia
  CREATE SEQUENCE StOdonto
        INCREMENT BY 1
        START WITH 1
        MAXVALUE 9999
        NOCACHE
...
--SECUENCIA Paciente Odontologia
  CREATE SEQUENCE SpOdonto
        INCREMENT BY 1
        START WITH 1
        MAXVALUE 9999
        NOCACHE
...
--SECUENCIA TIPO_paciente O
  CREATE SEQUENCE StpacienteO
        INCREMENT BY 1
        START WITH 1
        MAXVALUE 9999
        NOCACHE
...
CREATE OR REPLACE PACKAGE paquete_odontologia AS
    PROCEDURE add_TipoOdontologia(Ddescripcion varchar2);
    PROCEDURE add_PacienteOdontologia(Ipersona number,Imedico number,IDclinica number,Itodontologia number, iDiagnostico number, Dobservaciones varchar2);
END paquete_odontologia;

CREATE OR REPLACE PACKAGE BODY paquete_odontologia AS
    PROCEDURE add_TipoOdontologia(Ddescripcion varchar2) IS
        begin
    ...
    PROCEDURE add_PacienteOdontologia(Ipersona number,Imedico number,IDclinica number,Itodontologia number, iDiagnostico number, Dobservaciones varchar2) IS
        ...
        begin
            ...
            IDpaciente := SpOdonto.NEXTVAL;
                INSERT INTO PACIENTE_ODONTOLOGIA(ID_PERSONA,ID_PACIENTE_ODONTOLOGIA,ID_MEDICO,ID_CLINICA) VALUES(Ipersona,IDpaciente,Imedico,IDclinica);
            
            IDtipoO := StpacienteO.NEXTVAL;
                INSERT INTO TIPO_PACIENTE_O(IDTIPOPACIENTE,IDPACIENTE,IDTIPOODONTOLOGIA,IDDIAGNOSTICO,OBSERVACION,FECHAREGISTRO)
                    VALUES(IDtipoO,Ipersona,Itodontologia,iDiagnostico,Dobservaciones,SYSDATE);
        END add_PacienteOdontologia;
END paquete_odontologia;
...
INSERT INTO TIPO_ENFERMEDAD(ID_TIPO_ENFERMEDAD, TIPO_ENFERMEDAD, USUARIO_REGISTRO)
VALUES(1,'CANCER','JJOLONG');
INSERT INTO TIPO_ENFERMEDAD(ID_TIPO_ENFERMEDAD, TIPO_ENFERMEDAD, USUARIO_REGISTRO)
VALUES(2,'SIDA','JJOLONG');
INSERT INTO TIPO_ENFERMEDAD(ID_TIPO_ENFERMEDAD, TIPO_ENFERMEDAD, USUARIO_REGISTRO)
VALUES(3,'DOLOR DE CABEZA','JJOLONG');

SELECT * FROM ENFERMEDAD;

INSERT INTO ENFERMEDAD(ID_ENFERMEDAD, ID_TIPO_ENFERMEDAD, ENFERMEDAD, USUARIO_REGISTRO, DESCRIPCION, SOLUCION, FECHA_REGISTRO)
VALUES(1,1,'PROBLEMAS EN LA SANGRE','JJOLONG','DOLOR DE CABEZA, PROBLEMAS EN LA SANGRE','QUIMIOTERAPIA',SYSDATE);

INSERT INTO ENFERMEDAD(ID_ENFERMEDAD, ID_TIPO_ENFERMEDAD, ENFERMEDAD, USUARIO_REGISTRO, DESCRIPCION, SOLUCION, FECHA_REGISTRO)
VALUES(2,2,'INFLAMACION DE LAS ARTERIAS','JJOLONG','NO PUEDE COMER','PROBLEMAS RESPIRATORIOS',SYSDATE);

INSERT INTO ENFERMEDAD(ID_ENFERMEDAD, ID_TIPO_ENFERMEDAD, ENFERMEDAD, USUARIO_REGISTRO, DESCRIPCION, SOLUCION, FECHA_REGISTRO)
VALUES(3,3,'MIGRAÑA','JJOLONG','DOLOR DE CABEZA, PROBLEMAS EN LA SANGRE','QUIMIOTERAPIA',SYSDATE);

INSERT INTO SIGNOS_VITALES(ID_SIGNOS_VITALES,ID_PERSONA,FECHA_REGISTRO,USUARIO_REGISTRO,PRESION,PULSO,RESPIRACION,PESO,ALTURA,TEMPERATURA)
VALUES(1,1,SYSDATE,'JJLONG',160,100,80,90,160,36);
INSERT INTO SIGNOS_VITALES(ID_SIGNOS_VITALES,ID_PERSONA,FECHA_REGISTRO,USUARIO_REGISTRO,PRESION,PULSO,RESPIRACION,PESO,ALTURA,TEMPERATURA)
VALUES(2,4,SYSDATE,'JJLONG',180,100,180,190,180,36);
INSERT INTO SIGNOS_VITALES(ID_SIGNOS_VITALES,ID_PERSONA,FECHA_REGISTRO,USUARIO_REGISTRO,PRESION,PULSO,RESPIRACION,PESO,ALTURA,TEMPERATURA)
VALUES(3,3,SYSDATE,'JJLONG',160,100,80,90,160,36);
...
DELETE FROM  BANCOS;
DELETE FROM  CITA;
DELETE FROM  CITA_PERSONA;
DELETE FROM  CLIENTE;
DELETE FROM  CLINICAS;
DELETE FROM  COLONIA;
DELETE FROM  COMPANIA_TELEFONO;
DELETE FROM  COMPRAS;
DELETE FROM  CUENTA_PROVEEDORES;
...
DELETE FROM  DIRECCION_PERSONA;
DELETE FROM  DIRECCION_PROVEEDORES;
DELETE FROM  DOCUMENTO_PERSONA;
DELETE FROM  ENCARGADO_SEDE;
DELETE FROM  ENFERMEDAD;
DELETE FROM  ESPECIALIDAD;
DELETE FROM  ESPECIALIDAD_MEDICO;
DELETE FROM  EXAMEN_PERSONA;
DELETE FROM  EXAMENES;
DELETE FROM  FACTURACION;
DELETE FROM  FARMACIAS;
DELETE FROM  HISTORIAL_CLINICO;
DELETE FROM  INSUMO;
DELETE FROM  INSUMO_CLINICAS;
DELETE FROM  INSUMO_LABORATORIOS;
DELETE FROM  LAB_FARMACEUTICOS_INSUMOS;
DELETE FROM  LOTES;
DELETE FROM  MEDICO;
DELETE FROM  MENU;
DELETE FROM  MOVIMIENTOS_HISTORIAL;
DELETE FROM  MUNICIPIOS;
DELETE FROM  PACIENTE_ODONTOLOGIA;
...
DELETE FROM  RAZON_SOCIAL_PERSONA;
DELETE FROM  RESULTADOS_LABORATORIOS;
DELETE FROM  ROL;
...
DELETE FROM  STATUS;
DELETE FROM  SUSPENCION_MEDICA;
DELETE FROM  SUSPENCION_PERSONA;
DELETE FROM  TELEFONO;
DELETE FROM  TELEFONO_PERSONA;
DELETE FROM  TELEFONO_PROVEEDORES;
DELETE FROM  TIPO_DOCUMENTO;
DELETE FROM  TIPO_DOCUMENTOS_PAGO;
DELETE FROM  TIPO_ENFERMEDAD;
DELETE FROM  TIPO_PAGO_CLIENTES;
DELETE FROM  TIPO_PERSONAL_TECNICO;
DELETE FROM  TIPO_RAZON_SOCIAL;
DELETE FROM  TIPO_SANGRE;
DELETE FROM  TIPO_SEGURO;
DELETE FROM  TIPO_SERVICIO;
DELETE FROM  TIPO_SUSPENCION;
DELETE FROM  TIPO_TELEFONO;
DELETE FROM  TRANSACCIONES;
DELETE FROM  ZONAS;
DELETE FROM  TIPO_ODONTOLOGIA;
DELETE FROM  TIPO_PACIENTE_O;
DELETE FROM  ALIMENTO;
DELETE FROM  TIEMPO_COMIDA;
DELETE FROM  DIETA;
DELETE FROM  DETALLE_DIETA;
exec reset_seq( 'SALIMENTO');
exec reset_seq( 'SAPLICACION');
...
exec reset_seq( 'STSEGURO');
exec reset_seq( 'STTELEFONO');
exec reset_seq( 'Sdieta');
exec reset_seq( 'SDdieta');
