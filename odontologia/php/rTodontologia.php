<?php 
    ...
    try{
        $data = array();
        $st=$llamar->prepare("SELECT  (O.ID_PACIENTE_ODONTOLOGIA) AS CODIGO,(P.PRIMER_NOMBRE || ' ' || P.SEGUNDO_NOMBRE || ' ' || P.PRIMER_APELLIDO || '  ' || P.SEGUNDO_APELLIDO ) AS NOMBRE 
                                ,C.DESCRIPCION,  T.OBSERVACION,T.FECHAREGISTRO, dg.diagnostico
